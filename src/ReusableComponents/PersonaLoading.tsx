...
const PersonaLoading = () => {
    return (
        <div className=" items-center grid grid-cols-12   p-4   text-white  rounded-lg w-full  font-roboto animate-pulse">
            {/* Avatar */}
            <div className="col-span-1 w-10 h-10 rounded-full overflow-hidden bg-gray-700 mr-4">
            ...
            {/* User Info */}
            <div className="col-span-10 flex-grow flex flex-col gap-y-2">
            ...
            <button className=" bg-gray-700  col-span-1  w-15 h-15 rounded-2xl">
