    ...
    return <div className="w-full mx-auto  py-2  mt-4 rounded-lg ">
        ...
        <div className="flex gap-x-10 items-center md:flex-row flex-col justify-center ">
            ...
            <div className="flex w-[95%] mt-5 md:mt-0 md:w-[80%]  justify-between items-center  space-x-2">
                <button onClick={() => handlebuy(publicKey as string)} className="   text-white  no-underline  w-full bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br py-2 rounded-full border border-white">Buy </button>
