...
export default function Peoples(){
    ...
    return(
        ...
        <div className=" max-h-screen tablet:max-h-[98vh] border border-white/10 mb-16 xl:mb-0   tablet:rounded-l-2xl tablet:mt-[2vh] overflow-y-scroll bg-primaryColor    w-full md:bg-[#0E1014] min-h-screen  md:min-h-[96vh]">

    
          <div className="flex absolute p-4 items-center space-x-2  backdrop-blur-xl  bg-secondaryColor/20  w-full  tablet:w-[49.8%] rounded-2xl font-bold   "> 
